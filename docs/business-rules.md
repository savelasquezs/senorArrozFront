...
- **Producto gratis de la promoción**: El selector muestra solo productos activos de la categoría `Regalos` de la sucursal efectiva. Si no existen, queda vacío y no ofrece productos de otras categorías.
