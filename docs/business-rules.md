...
- **Producto gratis de la promoción**: El selector muestra solo productos activos de la categoría compartida `Regalos`. Productos y categorías de productos se comparten entre sucursales; si no existen regalos, el selector queda vacío y no ofrece productos de otras categorías.
