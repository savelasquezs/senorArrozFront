...
- **Alertas en la auditoría diaria**: Solo se incluyen GPS apagado, permiso de ubicación retirado y permanencias en lugares inesperados. Falta de comunicación, ubicaciones offline sincronizadas y jornada posterior al cierre siguen visibles en Alertas de seguimiento, pero no se envían en el resumen diario.
