...
- **Cajero en gastos**: Puede entrar al módulo, crear gastos y ver el historial. Solo puede **editar** gastos cuyo `createdAt` caiga en el **día calendario actual de `America/Bogota`**. Únicamente Admin y Superadmin pueden eliminar comprobantes de gasto.
