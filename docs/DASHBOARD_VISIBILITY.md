...
|--------------|----------------------|
| `principal` | KPIs, **tiempos prep. y entrega** (`DashboardGaugeCard` ×2), pipeline Kanban, actividad reciente |
| `ventas` | Comparación sucursales, evolución temporal, placeholder pedidos por estado |
| `gastos` | Placeholder (endpoint futuro) |
| `domicilios` | Operación / domiciliarios (`OperationOverviewPanel`; gauge de **solo tiempo de entrega**; prep. en Principal) |
