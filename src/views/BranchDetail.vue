    ...
    <MainLayout>
        <div class="p-6">
            ...
            <div v-else-if="branch" class="space-y-6">
                ...
                <BranchBanksAppsSection
                    v-if="activeBranchSection === 'banks-apps'"
                    :banks="banksStore.list?.items || []"
                    :banks-total-count="banksStore.list?.totalCount || 0"
                    :banks-loading="banksStore.isLoading"
                    :apps="appsStore.list?.items || []"
                    :apps-total-count="appsStore.list?.totalCount || 0"
                    :apps-loading="appsStore.isLoading"
                    :can-manage-banks="canManageBanks"
                    :can-manage-apps="canManageApps"
                    @create-bank="openCreateBank"
                    @edit-bank="openEditBank"
                    @delete-bank="deleteBank"
                    @create-app="openCreateApp"
