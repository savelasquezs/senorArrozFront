  ...
  <MainLayout>
    <div class="space-y-6 p-4 sm:p-6">
      ...
      <BaseDialog v-model="resolveOpen" title="Resolver alerta" size="lg" :close-on-backdrop="!saving">
        <div class="rounded-xl border border-amber-100 bg-amber-50 p-4 text-sm text-amber-900">La alerta quedará en el historial. Solo los cortes de GPS o permiso y las permanencias que requieren revisión se incluyen en la auditoría diaria.</div>
